    ...
    return (
        <div className="pt-8 px-5">
            ...
            <div className="bg-white border-2 py-5 px-6 rounded-xl shadow-lg z-3 relative w-11/12">
                <p className="text-lg">Ive missed more than 9,000 shots in my career. Ive lost almost 300 games. Twenty-six times Ive been trusted to take the game-winning shot and missed. Ive failed over and over and over again in my life. And that is why I succeed.</p>
